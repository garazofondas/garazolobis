        ...
        <div className="md:w-1/2 flex flex-col bg-white">
          <div className="p-4 border-b flex justify-between items-center bg-slate-50">
             <div className="flex items-center gap-3">
               <img src={part.seller.avatar} alt={part.seller.name} className="w-12 h-12 rounded-2xl object-cover border-2 border-white shadow-sm" />
               <div>
          ...
          <div className="p-8 bg-slate-900 flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              <button 
                className="py-4 px-6 bg-slate-800 border border-slate-700 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-700 transition-all"
                onClick={() => onMessage(part)}
              >
                Žinutė
              </button>
              <button 
                className="py-4 px-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-lg"
                onClick={() => onNegotiate(part)}
              >
                Derybos
              </button>
            </div>
            <button 
              className="py-4 px-6 bg-orange-600 hover:bg-orange-700 text-white rounded-2xl font-black text-sm uppercase tracking-widest transition-all shadow-lg shadow-orange-900/40"
