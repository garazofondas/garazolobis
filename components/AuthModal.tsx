            ...
            {!isLogin && (
              <div className="flex items-start gap-3 mt-4">
                ...
                <label htmlFor="terms" className="text-[10px] text-slate-500 leading-tight">
                  Sutinku su <a href="#" className="text-orange-600 underline">Taisyklėmis</a> ir patvirtinu, kad susipažinau su <a href="#" className="text-orange-600 underline">Privatumo politika</a> pagal LR įstatymus.
                </label>
              </div>
            )}
