        ...
        <div className="p-8">
          ...
          {step === 2 && (
            <div className="space-y-6 animate-in slide-in-from-right-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center">🏦</div>
                  <span className="text-xs font-black uppercase">Bank-Link (Swed/SEB)</span>
                </button>
              </div>
              <button 
                onClick={() => setStep(3)}
          ...
          {step === 3 && (
            <div className="space-y-6 animate-in slide-in-from-right-4">
              ...
              >
                {isProcessing ? (
                  <><div className="w-4 h-4 border-2 border-white/20 border-t-white rounded-full animate-spin"></div> JUNGIAMĖS SU BANKU...</>
